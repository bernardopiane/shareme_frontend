                        ...
                        {!imageAsset ? (
                            ...
                            <div className="relative h-full">
                                ...
                                <button
                                    ...
                                    className="absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md translate-x-full duration-500 ease-in-out">
                    ...
                    <div className="flex flex-col">
                        <div>
                            ...
                            >
                                ...
                                {categories.map(cat => (
                                    <option className='capitalize text-base border-0 outline-none bg-white text-black' key={cat.id} value={cat.id}>{cat.name}</option>
                                ))}
                            </select>
                        </div>
